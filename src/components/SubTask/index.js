...
import { PUBLICEYE, PRIVATEEYE, THUMBSUP, EMPTYCIRCLE, EMPTYCHECKEDCIRCLE, FILLEDCHECKEDCIRCLE } from '../TaskList/components/Task/Icon';
...
class SubTask extends React.Component {
    ...
    render() {
        let { title, givenClaps,  isPublic, isDone } = this.props.tasks;
        return (
                <Modal
                {...this.props}
                size="lg"
            ...
            >
                ...
                <Modal.Body>
                    <div className="container">
                        ...
                        <SubTaskList className ={"task row bg-light mt-2 p-2 rounded align-items-center"} task ={this.props.tasks}/>
                    </div>
                </Modal.Body>
            </Modal>
        );
